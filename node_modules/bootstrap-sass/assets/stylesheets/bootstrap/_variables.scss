...
$brand-primary:         darken(#38972C, 6.5%) !default; // #337ab7
$brand-success:         #00A54F !default;
$brand-info:            #AFFDD4 !default;
$brand-warning:         #EDE580 !default;
$brand-danger:          #AC3931 !default;
...
$font-family-serif:       'Rufina', serif !default;
...
$state-success-bg:               $brand-primary !default;
$state-success-border:           darken(adjust-hue($state-success-bg, -10), 5%) !default;

$state-info-text:                #333 !default;
...
$panel-warning-text:          #8a6d3b !default;
